...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            public static GUIContent brgShaderVariantStorageStripType = EditorGUIUtility.TrTextContent("BRG Storage", "Select BRG use ssbo/uniform or texture to store data.");
